...
function detectCollision(lstones,lmango){
	...
	if(lstones.body.position.x- lmango.body.position.x <=lmango.width + lstones.width
		...
		&&lstones.body.position.y -lmango.body.position.y <= lmango.width + lstones.width
		&& lmango.body.position.y - lstones.body.position.y <= lmango.width + lstones.width){
